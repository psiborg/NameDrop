...
class FileRenamerGUI:
    ...
    def setup_ui(self):
        ...
        dnd_text = "Files to Rename" if TKDND_AVAILABLE else "Files to Rename"
        ...
        self.edit_minor_btn = ttk.Button(self.minor_frame, text="Edit Words",
        ...
        self.case_options_frame.grid(row=1, column=1, sticky=tk.W, pady=5)
        ...
        self.datetime_frame.grid(row=1, column=1, sticky=tk.W, pady=5)

        ttk.Label(self.datetime_frame, text=f"Format: {self.datetime_format}").pack(side=tk.LEFT, padx=(0, 10))

        self.edit_datetime_btn = ttk.Button(self.datetime_frame, text="Edit Format",
        ...
        ttk.Label(options_frame, text="Additional:").grid(row=5, column=0, sticky=tk.W, pady=5)
        ...
        ttk.Button(special_frame, text="Edit Characters",
        ...
        ttk.Button(action_frame, text="Preview", command=self.preview_changes,
                  width=20).pack(side=tk.LEFT, padx=(0, 10))
        ttk.Button(action_frame, text="Rename", command=self.convert_files,
